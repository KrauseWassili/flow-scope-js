    ...
    <main className="flex-1 h-full overflow-hidden">
      ...
      <div className="h-full overflow-x-auto">
        <div className="grid grid-cols-[1fr_2fr] min-w-100 h-full">
          ...
          {/* LEFT */}
          <div className="flex flex-col border-border border-r min-w-95 sm:min-w-170 min-h-0 h-full shrink-0 overflow-hidden">
            <ClientArea />
          </div>

          {/* RIGHT */}
          <div className="flex flex-col min-w-190 sm:min-w-230 min-h-0 h-full shrink-0 overflow-hidden">
